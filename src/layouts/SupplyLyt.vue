  ...
  <q-layout view="lHh Lpr lFf">
    <q-header bordered class="transparent text-dark">
      <q-toolbar class="row justify-between items-center">
        <div class="text-bold">Resurtido </div>
        <div class="row">
    ...
    <q-page-container>
      <OrdersSupplyComp :dash="dashvalue" />
    </q-page-container>
  </q-layout>
</template>
...
import OrdersSupplyComp from 'src/components/OrdersSupply.vue';
...
const sktOrderChangeState = async skt => {
  ...
  if (newstate.id == 3) {
    $q.notify({
      message: `El pedido <b>${order.id}</b> esta listo para surtir!!`,
      color: "positive",
      textColor: "white",
      position: "bottom",
      html: true,
